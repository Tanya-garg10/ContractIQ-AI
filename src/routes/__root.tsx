...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ContractIQ AI — Multi-Agent Contract Intelligence" },
      { name: "description", content: "Upload any contract and let a team of AI agents extract clauses, flag risks, and answer your questions in seconds." },
      { name: "author", content: "ContractIQ AI" },
      { property: "og:title", content: "ContractIQ AI — Multi-Agent Contract Intelligence" },
      { property: "og:description", content: "AI agents that read your contracts, find the risks, and answer your questions." },
